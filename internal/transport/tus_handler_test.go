...
func TestRouter_Health(t *testing.T) {
	...
	_ = uploadSvc
	router := NewRouter(mw, tusHandler, restHandler, downloadHandler, nil, nil, nil, nil)
...
func TestRouter_CheckExists(t *testing.T) {
	...
	router := NewRouter(mw, tusHandler, restHandler, downloadHandler, nil, uploadSvc, nil, nil)
